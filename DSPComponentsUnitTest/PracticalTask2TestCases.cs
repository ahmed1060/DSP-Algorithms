...
namespace DSPComponentsUnitTest
{
    ...
    public class PracticalTask2TestCases
    {
        ...
        public void PracticalTask2TestCaseECG()
        {
            ...
            var expectedOutput = UnitTestUtitlities.LoadSignal("E:/5th Semester/Digital Signal Processing/Labs/DSPToolbox/DSPComponentsUnitTest/TestingSignals/FileDown.ds");
